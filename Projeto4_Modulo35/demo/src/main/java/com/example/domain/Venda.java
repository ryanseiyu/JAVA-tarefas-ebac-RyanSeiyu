...
public class Venda implements Persistente {
    ...
    private Set<Quantidade> produtos;
    ...
    public Set<Quantidade> getProdutos() {
        return produtos;
    }

    public void adicionarProduto(Produto produto, Integer quantidade) {
        validarStatus();
        Optional<Quantidade> op = produtos.stream()
                .filter(filter -> filter.getProduto().getCodigo().equals(produto.getCodigo())).findAny();
        if (op.isPresent()) {
            Quantidade produtpQtd = op.get();
            produtpQtd.adicionar(quantidade);
        } else {
            Quantidade prod = new Quantidade();
            prod.setVenda(this);
    ...
    public void recalcularValorTotalVenda() {
        ...
        for (Quantidade prod : this.produtos) {
    ...
    public void setProdutos(Set<Quantidade> produtos) {
